#include <FastLED.h>
#include "WindowAndWallAnimations.hpp"


void WindowAndWallAnimations::setup() {
  // Setup debugger
  #ifdef DEBUG
  Serial.begin(9600);
  #endif
...
void WindowAndWallAnimations::loop() {
  //-------/
...
void WindowAndWallAnimations::Fire2012_WholeWall(int whichFireWall){
